...
| `fm-gate-refuse-lib.sh`  | Gate-context fleet lifecycle refusal with structural lab authorization                |
| `fm-lab-home.sh`        | Create, adopt, verify, and tear down disposable marked lab homes                       |
